            ...
            <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
              <el-form ref="userRef" :model="user" style="width:80%" status-icon :rules="rules" label-width="auto" class="demo-user">
                ...
                <el-form-item label="用户名" prop="username">
                  <el-input prefix-icon="User" size="default" placeholder="请输入用户名" v-model="user.username" autocomplete="off" />
                </el-form-item>
                ...
                <el-form-item  label="确认密码" prop="password">
                  <el-input show-password prefix-icon="Lock" size="default" placeholder="请确认密码" v-model="user.password" autocomplete="off"/>
                </el-form-item>
                <el-form-item>
                  <el-button type="primary" style="width: 100%;" @click="submitForm(userRef)">注册</el-button>
                </el-form-item>
                <div>已有帐号？请<span style="color: #0f9876; cursor: pointer;">登录</span></div>
              </el-form>
            </div>
        </div>
    </div>
